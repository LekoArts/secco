...
For the purpose of this guide a couple of script were chosen to explain the necessary steps. You can use any tool you like though, for example [execa's scripts interface](https://github.com/sindresorhus/execa#script).
